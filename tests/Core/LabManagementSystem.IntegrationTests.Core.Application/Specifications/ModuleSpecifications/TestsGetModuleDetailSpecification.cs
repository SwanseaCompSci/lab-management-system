...
{
    public sealed class TestsGetModuleDetailSpecification : TestBase
    {
        [Test]
        public async Task Specified_Entities_Found()
        {
            ...
            var specification = new GetModuleDetailSpecification(moduleId: modules[0].Id);
        ...
        public void Specified_Entities_Not_Found()
        {
            ...
            var specification = new GetModuleDetailSpecification(moduleId: Guid.Parse("8f391b26-6d8a-488b-adfd-06c631a90f66"));

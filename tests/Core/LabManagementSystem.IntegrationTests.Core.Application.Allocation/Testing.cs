...
namespace SwanseaCompSci.LabManagementSystem.IntegrationTests.Core.Application.Allocation
{
    ...
    public partial class Testing
    {
        ...
        public async Task RunBeforeAnyTests()
        {
            ...
            services.AddApplicationAllocationServices();
    ...
    public partial class Testing
    {
        private static void ReplaceICurrentUserService(ServiceCollection services)
        {
            ...
            services.AddTransient(provider =>
            {
                ...
                mock.SetupGet(d => d.UserId).Returns(Helpers.GetUserId(User));
                mock.SetupGet(d => d.UserName).Returns(Helpers.GetUserName(User));
                mock.SetupGet(d => d.UserFirstName).Returns(Helpers.GetUserFirstName(User));
                mock.SetupGet(d => d.UserSurname).Returns(Helpers.GetUserSurname(User));
                mock.SetupGet(d => d.UserApplicationRole).Returns(Helpers.GetApplicationRole(User));
                return mock.Object;
            });
        }

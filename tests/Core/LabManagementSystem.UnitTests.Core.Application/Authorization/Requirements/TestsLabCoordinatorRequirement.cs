...
{
    public class TestsLabCoordinatorRequirement
    {
        [Test]
        public async Task HandleRequirementAsync_Administrator_ModuleEntity_Authorized()
        {
            ...
            var context = new AuthorizationHandlerContext(requirements: new IAuthorizationRequirement[] { new LabCoordinatorRequirement() },
                user: claimsPrincipal,
                resource: modules[0]);

            await new LabCoordinatorModuleRequirementHandler(dbContext).HandleAsync(context);
        ...
        public async Task HandleRequirementAsync_Administrator_ModuleModel_Authorized()
        {
            ...
            await new LabCoordinatorModuleModelRequirementHandler(dbContext).HandleAsync(context);
        ...
        public async Task HandleRequirementAsync_Administrator_LabEntity_Authorized()
        {
            ...
            await new LabCoordinatorLabRequirementHandler(dbContext).HandleAsync(context);
        ...
        public async Task HandleRequirementAsync_Administrator_LabModel_Authorized()
        {
            ...
            await new LabCoordinatorLabModelRequirementHandler(dbContext).HandleAsync(context);
        ...
        public async Task HandleRequirementAsync_ModuleCoordinator_ModuleEntity_Unauthorized()
        {
            ...
            reason.Message.Should().Be($"User (ca9ee2de-762c-4a72-8961-8cf18e4df54f) does not have a ModuleCoordinator or LabCoordinator role for Module ({modules[1].Id}).");
        }
        [Test]
        ...
        [Test]
        public async Task HandleRequirementAsync_LabCoordinator_ModuleEntity_Authorized()
        {
            var users = new User[]
            {
                new User(id: Guid.Parse("ca9ee2de-762c-4a72-8961-8cf18e4df54f"), firstName: "Jozef", surname: "Gabčík", achievedLevel: Level.PhD, maxWeeklyWorkHours: 48),
        ...
        {
            // Lab Coordinator for a different lab
        ...
        [Test]
        public async Task HandleRequirementAsync_LabCoordinator_ModuleModel_Authorized()
        {
            var users = new User[]
            {
                new User(id: Guid.Parse("ca9ee2de-762c-4a72-8961-8cf18e4df54f"), firstName: "Jozef", surname: "Gabčík", achievedLevel: Level.PhD, maxWeeklyWorkHours: 48),
        ...
        [Test]
        public async Task HandleRequirementAsync_LabCoordinator_LabEntity_Authorized()
        {
            var users = new User[]
            {
                new User(id: Guid.Parse("ca9ee2de-762c-4a72-8961-8cf18e4df54f"), firstName: "Jozef", surname: "Gabčík", achievedLevel: Level.PhD, maxWeeklyWorkHours: 48),
        ...
        [Test]
        public async Task HandleRequirementAsync_LabCoordinator_LabModel_Authorized()
        {
            var users = new User[]
            {
                new User(id: Guid.Parse("ca9ee2de-762c-4a72-8961-8cf18e4df54f"), firstName: "Jozef", surname: "Gabčík", achievedLevel: Level.PhD, maxWeeklyWorkHours: 48),
        ...
        [Test]
        public async Task HandleRequirementAsync_TeachingAssistant_ModuleEntity_Unauthorized()
        {
            var users = new User[]
            {
                new User(id: Guid.Parse("ca9ee2de-762c-4a72-8961-8cf18e4df54f"), firstName: "Jozef", surname: "Gabčík", achievedLevel: Level.PhD, maxWeeklyWorkHours: 48),
            ...
            context.FailureReasons.Should().HaveCount(1);
            var reason = context.FailureReasons.FirstOrDefault() ?? throw new NullReferenceException();
            reason.Message.Should().Be($"User (ca9ee2de-762c-4a72-8961-8cf18e4df54f) does not have a ModuleCoordinator or LabCoordinator role for Module ({modules[0].Id}).");
        }
        [Test]
        public async Task HandleRequirementAsync_TeachingAssistant_ModuleModel_Unauthorized()
        {
            var users = new User[]
            {
                new User(id: Guid.Parse("ca9ee2de-762c-4a72-8961-8cf18e4df54f"), firstName: "Jozef", surname: "Gabčík", achievedLevel: Level.PhD, maxWeeklyWorkHours: 48),
        ...
        [Test]
        public async Task HandleRequirementAsync_TeachingAssistant_LabEntity_Unauthorized()
        {
            var users = new User[]
            {
                new User(id: Guid.Parse("ca9ee2de-762c-4a72-8961-8cf18e4df54f"), firstName: "Jozef", surname: "Gabčík", achievedLevel: Level.PhD, maxWeeklyWorkHours: 48),
        ...
        [Test]
        public async Task HandleRequirementAsync_TeachingAssistant_LabModel_Unauthorized()
        {
            var users = new User[]
            {
                new User(id: Guid.Parse("ca9ee2de-762c-4a72-8961-8cf18e4df54f"), firstName: "Jozef", surname: "Gabčík", achievedLevel: Level.PhD, maxWeeklyWorkHours: 48),
